...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'jquery', '//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js', array(), '1.8.3' );

	// full jQuery UI
	$scripts->add( 'jquery-ui-full', '//ajax.googleapis.com/ajax/libs/jqueryui/1.10.3/jquery-ui.min.js', array('jquery'), '1.9.2', 1 );
