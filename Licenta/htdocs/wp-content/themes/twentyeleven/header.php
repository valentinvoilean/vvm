...
<![endif]-->
<!-- jQuery UI styles -->
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/ui-lightness/jquery-ui.css" id="theme">
...
<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.fileupload-fp.js"></script>
<!-- The File Upload user interface plugin -->
<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.fileupload-ui.js"></script>
<!-- The File Upload jQuery UI plugin -->
<script src="<?php echo get_template_directory_uri(); ?>/js/jquery.fileupload-jui.js"></script>
